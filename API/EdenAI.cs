    ...
    public class EdenAI
    {
        public async Task<string> Get(string title)
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                Content = new StringContent($"{{\"response_as_dict\":false,\"attributes_as_list\":false,\"show_original_response\":false,\"resolution\":\"1024x1024\",\"num_images\":1,\"providers\":\"replicate\",\"text\":\"{title} movie poster\"}}")
                {
                    Headers =
                    {
